...
const Register = () => {
  return (
    <div className="w-full h-screen flex items-center lg:justify-between justify-center">
        ...
        <form className='lg:w-[50%] md:w-[60%] sm:w-[70%] w-[100%] sm:h-[75%] h-[80%] flex items-center justify-center'>
          <div className='xl:w-[60%] w-[90%] h-[100%] bg-white rounded-2xl relative overflow-hidden'>
              ...
              <div className='w-[100%] h-[80%] bg-[#2970ff] absolute bottom-0 rounded-tl-[5rem] py-12 px-6'>
                  <div>
